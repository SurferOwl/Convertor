...
public class MainFrame extends JFrame {
   ...
   private JButton lesButton;

    {
        ...
        convertRONtoOth.setText("Calculate to show the currencies");
   ...
   public int getToIndex(){
    ...
    public void setCurrencyOne(String currencyOne) {
        this.currencyOne.setText(currencyOne);
    }

    public JLabel getCurrencyTwo() {
        return currencyTwo;
    }

    public void setCurrencyTwo(String currencyTwo) {
        this.currencyTwo.setText(currencyTwo);
    }
}
